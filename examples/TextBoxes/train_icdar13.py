...
# path_to_train_lmdb = 'examples/ICDAR13'
# path_to_test_lmdb = 'examples/ICDAR13'

path_to_train_lmdb = '/home/buralako/dataset-txt/AccessMathVOC/AccessMath/lmdb'
path_to_test_lmdb = '/home/buralako/dataset-txt/AccessMathVOC/AccessMath/lmdb'
...
train_data = os.path.join(path_to_train_lmdb, "AccessMath_train_lmdb")
# The database file for testing data. Created by data/text_10x/create_data.sh
test_data = os.path.join(path_to_test_lmdb, "AccessMath_val_lmdb")
...
min_dim = min([resize_height, resize_width]) #300
# conv4_3 ==> 38 x 38
# fc7 ==> 19 x 19
# conv6_2 ==> 10 x 10
# conv7_2 ==> 5 x 5
...
if code_type == P.PriorBox.CENTER_SIZE:
  ...
  prior_variance = [0.2, 0.2, 0.4, 0.4]
else:
  prior_variance = [0.1]
flip = False
clip = True
...
# Check file.
assert check_if_exist(train_data)
assert check_if_exist(test_data)
assert check_if_exist(label_map_file)
assert check_if_exist(pretrain_model)
